  ...
  endpoints: {
    ...
    meetingAnalysis: {
      ...
      results: (sessionId: string) =>
        `/api/v1/analysis/sessions/${sessionId}/results`,
      analyze: (sessionId: string) =>
        `/api/v1/analysis/sessions/${sessionId}/analyze`,
      status: (sessionId: string) => `/api/v1/analysis/sessions/${sessionId}`,
      visualization: (sessionId: string) =>
        `/api/v1/analysis/sessions/${sessionId}/visualization`,
    },
    agents: {
      ...
      progress: (sessionId: string) =>
        `/api/v1/agents/sessions/${sessionId}/progress`,
    },
    visualizations: {
