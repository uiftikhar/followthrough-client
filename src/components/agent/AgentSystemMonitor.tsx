...
export default function AgentSystemMonitor({
  ...
  const [statusReport, setStatusReport] = useState<AgentStatusReport | null>(
    null,
  );
      ...
      <div className={`rounded border bg-red-50 p-4 shadow ${className}`}>
        <div className="flex h-20 flex-col items-center justify-center">
          <p className="font-medium text-red-500">
            Failed to load agent system status
          </p>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="rounded border p-2">
                  ...
                  <p>
                    RSS:{" "}
                    {Math.round(statusReport.system.memory.rss / 1024 / 1024)}{" "}
                    MB
                  </p>
                  <p>
                    Heap Total:{" "}
                    {Math.round(
                      statusReport.system.memory.heapTotal / 1024 / 1024,
                    )}{" "}
                    MB
                  </p>
                  <p>
                    Heap Used:{" "}
                    {Math.round(
                      statusReport.system.memory.heapUsed / 1024 / 1024,
                    )}{" "}
                    MB
                  </p>
                </div>
