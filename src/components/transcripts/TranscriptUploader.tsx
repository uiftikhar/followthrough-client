    ...
    <div className="mx-auto w-full max-w-2xl">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          {isDragActive ? (
            <p className="font-medium text-blue-500">Drop the file here...</p>
          ) : (
            <div className="space-y-2">
              <p className="font-medium">
                Drag and drop a transcript file or click to browse
              </p>
      ...
      {acceptedFiles.length > 0 && (
        <div className="mt-4 rounded-md border border-gray-200 p-4 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            {acceptedFiles[0].name} ({(acceptedFiles[0].size / 1024).toFixed(2)}{" "}
            KB)
          </p>
        </div>
      )}
      ...
      {isError && (
        <div className="mt-4 rounded-md border border-red-200 bg-red-50 p-4 text-red-700 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400">
